...
**
** Created: Mon Dec 26 14:52:19 2011
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tabWidget->setGeometry(QRect(0, 0, 90, 101));
        ...
        canvas2D->setGeometry(QRect(0, 0, 84, 72));
        ...
        horizontalLayout_2 = new QHBoxLayout(tab3D);
        ...
        horizontalLayout_2->addWidget(canvas3D);
        ...
        emitterDock->setMinimumSize(QSize(218, 488));
        emitterDock->setFocusPolicy(Qt::StrongFocus);
        emitterDockContents = new QWidget();
        emitterDockContents->setObjectName(QString::fromUtf8("emitterDockContents"));
        emitterDock->setWidget(emitterDockContents);
        MainWindow->addDockWidget(static_cast<Qt::DockWidgetArea>(1), emitterDock);
