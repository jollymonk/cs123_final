...
extern Matrix4x4 getScaleMat(const Vector4 &v_scale);
/// @returns the translation matrix described by the vector
extern Matrix4x4 getTransMat(const Vector4 &v_trans);
...
extern Matrix4x4 getRotMat  (const Vector4 &p_rot, const Vector4 &v_rot, const REAL radians);
...
extern Matrix4x4 getInvScaleMat(const Vector4 &v_scale);
/// @returns the inverse translation matrix described by the vector
extern Matrix4x4 getInvTransMat(const Vector4 &v_trans);
...
extern Matrix4x4 getInvRotMat  (const Vector4 &p_rot, const Vector4 &v_rot, const REAL radians);

//@}-----------------------------------------------------------------------------

extern bool isZeroMat(const Matrix4x4 m);

extern bool equals(const Matrix4x4 m1, const Matrix4x4 m2);

extern void printMatrix(Matrix4x4 m);
