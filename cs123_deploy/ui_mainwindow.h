...
**
** Created: Tue Dec 13 17:10:54 2011
...
public:
    ...
    QDockWidget *rayDock;
    QDockWidget *emitterDock;
    QWidget *emitterDockContents;
    QPushButton *beginSimButton;
    QWidget *rayDockContents;
    QVBoxLayout *verticalLayout_4;
    QVBoxLayout *verticalLayout_12;
    QWidget *rayAllOrNone;
    QWidget *beginSimWidget;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        canvas2D->setGeometry(QRect(0, 0, 353, 2822));
        ...
        emitterDock = new QDockWidget(MainWindow);
        rayDock->setObjectName(QString::fromUtf8("rayDock"));
        emitterDock->setObjectName(QString::fromUtf8("emitterDock"));
        rayDockContents = new QWidget();

        rayDockContents->setObjectName(QString::fromUtf8("rayDockContents"));
        emitterDockContents->setObjectName(QString::fromUtf8("emitterDockContents"));
        verticalLayout_4 = new QVBoxLayout(rayDockContents);
        verticalLayout_12 = new QVBoxLayout(emitterDockContents);
...
//*************************************************
        ...
        emitterDockContents = new QWidget();
        verticalLayout_12 = new QVBoxLayout(emitterDockContents);
        verticalLayout_12->setSpacing(6);
        verticalLayout_12->setContentsMargins(11, 11, 11, 11);
        verticalLayout_12->setObjectName(QString::fromUtf8("verticalLayout_12"));

        beginSimWidget = new QWidget(emitterDockContents);
        beginSimWidget->setObjectName(QString::fromUtf8("beginSimWidget"));
        horizontalLayout = new QHBoxLayout(beginSimWidget);

        beginSimButton = new QPushButton(beginSimWidget);
        beginSimButton->setObjectName(QString::fromUtf8("beginSimButton"));

        verticalLayout_12->addWidget(beginSimButton);
        horizontalLayout->addWidget(beginSimButton);
        ...
        rotN = new QDial(cameraRotation_2);
        rotN->setObjectName(QString::fromUtf8("rotN"));
        rotN->setMinimumSize(QSize(60, 60));
        rotN->setMaximumSize(QSize(60, 60));
        rotN->setMinimum(-360);
        rotN->setMaximum(360);
        rotN->setSingleStep(10);
        rotN->setPageStep(30);
        rotN->setOrientation(Qt::Horizontal);
        rotN->setInvertedControls(true);
        rotN->setWrapping(true);

        gridLayout_15->addWidget(rotN, 0, 2, 1, 1);
        ...
        QObject::connect(rotN, SIGNAL(valueChanged(int)), canvas3D, SLOT(updateCameraRotationN()));
        ...
        QObject::connect(beginSimButton, SIGNAL(clicked()), MainWindow, SLOT(beginSimulation()));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "CS 123: Graphics Final", 0, QApplication::UnicodeUTF8));
        ...
        emitterDock->setWindowTitle(QApplication::translate("MainWindow", "Fountain", 0, QApplication::UnicodeUTF8));
        ...
        beginSimButton->setText(QApplication::translate("MainWindow", "Begin Simulation", 0, QApplication::UnicodeUTF8));
        ...
        cameraRotationLabelRoll->setText(QApplication::translate("MainWindow", "N", 0, QApplication::UnicodeUTF8));
